...
negative strands. The scores for G4s are positive on the positive strand and 
negative on the negative strand, resulting in a bimodal distribution of 
`max_score` and `score`. Please note that the positive or negative score 
reflects only the strand type of the G4, whereas the capability of the G4 
